  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-sm font-semibold text-hommentor-blue uppercase tracking-wider">{t('home.featuresLabel')}</p>
            ...
            highlight={
              <div className="mt-6 flex items-center gap-3">
                ...
                <p className="text-sm text-slate-600">
                  <span className="font-semibold text-hommentor-ink">{t('home.featuresTile1Highlight')}</span>
                </p>
              </div>
            }
          />
        ...
        >
          <Phone className="w-4 h-4 text-hommentor-blue" />
          <span>
            {t('home.featuresTalkFirst')}{" "}
            <a href="tel:+919203149956" className="font-semibold text-hommentor-blue hover:underline">
              +91 9203149956
            </a>
          </span>
        </motion.div>
...
const accentBg = {
  blue: "bg-blue-50 text-hommentor-blue",
  amber: "bg-amber-50 text-amber-600",
  coral: "bg-rose-50 text-hommentor-coral",
...
const Tile = ({
  ...
  <motion.div
    ...
    className={`group relative ${colSpan} bg-white border border-slate-200 rounded-3xl p-6 sm:p-7 hover:border-hommentor-gold hover:shadow-xl hover:-translate-y-1 transition-all overflow-hidden`}
  >
    ...
    <h3 className="font-heading font-bold text-xl sm:text-2xl text-hommentor-ink leading-snug">
      {title}
    </h3>
    ...
    <div
      aria-hidden
      className="absolute -bottom-20 -right-20 w-44 h-44 bg-gradient-to-tr from-hommentor-blue/10 via-amber-200/20 to-transparent rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
    />
  </motion.div>
);
