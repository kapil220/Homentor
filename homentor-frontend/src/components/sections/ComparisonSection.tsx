...
const ComparisonSection = () => {
  ...
  return (
    <section className="py-20 bg-hommentor-mist relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-sm font-semibold text-hommentor-blue uppercase tracking-wider">{t('home.compLabel')}</p>
        ...
        >
          <div className="grid grid-cols-3 bg-gradient-to-r from-hommentor-mist to-blue-50 border-b border-slate-200">
            ...
            <div className="px-5 py-5 text-sm font-bold text-hommentor-blue border-l border-slate-200 inline-flex items-center gap-2">
              <span className="inline-flex w-6 h-6 rounded-md bg-hommentor-blue text-white items-center justify-center text-[10px] font-extrabold">H</span>
              hommentor
            </div>
          </div>
          {rows.map((r, i) => (
            ...
            >
              <div className="px-5 py-4 sm:py-5 font-medium text-hommentor-ink text-sm sm:text-base">
                {r.topic}
              </div>
              ...
              <div className="px-5 py-4 sm:py-5 border-l border-slate-100 flex items-start gap-2 text-sm text-hommentor-ink font-medium bg-blue-50/40">
