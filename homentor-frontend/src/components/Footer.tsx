        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          <div className="md:col-span-2 space-y-6">
            ...
            <p className="text-gray-600">
              Homentor is a trusted platform that enables students to directly call, message and book verified home tutors in their area.
            </p>
            <div className="space-y-3">
              <div className="flex items-center">
                <Mail className="h-5 w-5 text-homentor-blue mr-2" />
                <a href="mailto:homentorindia@gmail.com" className="text-gray-700 hover:text-homentor-blue transition-colors">homentorindia@gmail.com</a>
              </div>
              <div className="flex items-center">
                <Phone className="h-5 w-5 text-homentor-blue mr-2" />
                <a href="tel:+919203149956" className="text-gray-700 hover:text-homentor-blue transition-colors">+91 9203149956</a>
              </div>
              <div className="flex items-center">
            ...
            <div className="flex space-x-4 pt-2">
              <a href="https://www.facebook.com/profile.php?id=61568577280975" className="bg-homentor-lightBlue p-2 rounded-full text-homentor-blue hover:bg-homentor-blue hover:text-white transition-all">
                <span className="sr-only">Facebook</span>
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </a>
              <a href="https://www.instagram.com/homentor_official?igsh=MTZzNDQ1NDdwaTQyZA%3D%3D&utm_source=qr" className="bg-homentor-lightBlue p-2 rounded-full text-homentor-blue hover:bg-homentor-blue hover:text-white transition-all">
