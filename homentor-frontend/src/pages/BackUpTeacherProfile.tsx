...
const BackUpTeacherProfile = () => {
  ...
  const handleConfirm = () => {
    ...
    axios.post(
      `https://homentor-backend.onrender.com/api/class-bookings/${bookingId}/change-teacher`,
      {
                  ...
                  <div className="flex flex-col justify-evenly">
                    <div className="flex items-center gap-1 bg-blue-50 border text-blue-700 hover:bg-blue-100 border-blue-500 py-1 px-2 rounded-[10px]">
                      ...
                      {[...Array(5)].map((_, index) => (
                        <Star
                          key={index}
                          className={`h-4 w-4 ${index < Math.round(mentorData.rating)
                      ...
                      <div className="flex justify-between">
                        ...
                        <div className="text-right w-[45%]">
                          <p className="text-4xl font-bold text-yellow-600 tracking-wide text-nowrap">
                            ₹ {mentorData?.teachingModes?.homeTuition?.finalPrice}
                          </p>
...
export default BackUpTeacherProfile;
